...
import { categories, products, styles, imagePath } from "@/lib/catalog";
    ...
    <main id="main">
      <section className="hero">
        <Image
          ...
          alt="Indian woman wearing an emerald and kundan necklace with matching earrings"
          fill
          preload
          sizes="100vw"
        />
        <div className="hero-content container">
          <span className="eyebrow">THE EVERY YOU COLLECTION</span>
          <h1>
            Timeless Jewellery,
            <br />
            Made for <em>Every You.</em>
          </h1>
          <p>
            Discover contemporary Indian jewellery
            <br className="desktop-break" /> crafted to celebrate every
            occasion.
          </p>
          <Link href="/collections/new-in" className="button">
            Shop new collection <ArrowRight size={17} />
          </Link>
          <Link className="hero-secondary" href="#categories">
            Explore collections <ArrowRight size={15} />
          </Link>
        </div>
        <div className="hero-caption">ROOTED IN HERITAGE. MADE FOR TODAY.</div>
        <div className="hero-edition">THE NEW SEASON &nbsp; / &nbsp; 2026</div>
      </section>
      ...
      <section className="section container categories-section" id="categories">
        <SectionHeading
          eyebrow="A LITTLE SOMETHING FOR EVERY YOU"
          title="Shop by Category"
          copy="Find the perfect piece for every occasion."
        />
        <Carousel label="Jewellery categories">
